class LessonsController < ApplicationController
  ...
  def lesson_params
		params.require(:lesson).permit(:name, :summary, :course_id, :id, questions: [:content, :category, :lesson_id, :id, :answers], responses: [:content, :lesson_id, :user_id, :question_id])
	end
